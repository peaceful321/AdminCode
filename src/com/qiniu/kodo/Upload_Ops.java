...
//		ops();
	...
	public static void slice() {
		...
		//上传文件路径
		String filePath = "/Users/ryanxu/Downloads/videos/mayun.mp4";
		//上传的存储空间
		String bucket = "live-bucket";
		//在存储空间的命名
		String key = "mayun8_3.mp4";
		...
		String uptoken = auth.uploadToken(bucket, key, 3600, new StringMap()
					.putNotEmpty("persistentOps", opfs.toString())
					.putNotEmpty("persistentNotifyUrl", "http://8affbb23.ngrok.io/WebProject/callback")
